...
public class AlienSpritesheetInfo {
    ...
    public static final int RUNNER_ATTACK_START_X = 398;
    public static final int RUNNER_ATTACK_START_Y = 408;
    public static final int RUNNER_DEATH_FRAMES_WIDTH = 122;
    ...
    public static final int QUEEN_WIDTH = 132;
    public static final int QUEEN_HEIGHT = 254;
    public static final int QUEEN_START_X = 0;
    public static final int QUEEN_START_Y = 50;

    public static final int QUEEN_WINGS_WIDTH = 240;
    public static final int QUEEN_WINGS_HEIGHT = 300;
    public static final int QUEEN_WINGS_START_X = 408;
    public static final int QUEEN_WINGS_START_Y = 0;
}
